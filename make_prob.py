...
def make_samples(dir):
    ...
    os.chdir("/Users/advitiyajadhav/programming/competitive-programming/create")
    #making samples
    a_file = open("txt.json", "r")
    a_json = json.load(a_file)
    j = 1
    ...
    #os.chdir(f"{dir}/samples")
    cpp_file_name = dir[-1:]
    os.system(f"cp /Users/advitiyajadhav/programming/competitive-programming/create/main.cpp {dir}")
    os.system(f"mv {dir}/main.cpp {dir}/{cpp_file_name}.cpp")
    #print(list)

def create_files(dir):
    os.chdir(dir)
    os.system(f"cp /Users/advitiyajadhav/programming/competitive-programming/create/Makefile {dir}")
    make_samples(dir)
    #os.chdir("/Users/sandisk/Desktop/tmp/programming/cpp2")
    os.chdir("/Users/advitiyajadhav")
...
def download_problem_to_json(j):
    ...
    argument = '...'
    cur = os.getcwd()
    os.chdir("/Users/advitiyajadhav"),os.chdir("programming"),os.chdir("competitive-programming"),os.chdir("create")
